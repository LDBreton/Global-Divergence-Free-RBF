...
M_phi1 = BuildMGram(fbrAnzatz(:,1),{P_ni},Centros,Tipo,var_c,var_muu);
M_phi2 = BuildMGram(fbrAnzatz(:,2),{P_ni},Centros,Tipo,var_c,var_muu);
M_Lphi1 = BuildMGram(fbrGram(:,1),{P_ni},Centros,Tipo,var_c,var_muu);
M_Lphi2 = BuildMGram(fbrGram(:,2),{P_ni},Centros,Tipo,var_c,var_muu);
M_Bphi1 = BuildMGram(fbrGram(:,3),{P_f},Centros,Tipo,var_c,var_muu);
M_Bphi2 = BuildMGram(fbrGram(:,4),{P_f},Centros,Tipo,var_c,var_muu);
Interpolation_matrixPx = BuildMGram(fbrGram(:,5),{P_ni},Centros,Tipo,var_c,var_muu);
Interpolation_matrixPy = BuildMGram(fbrGram(:,6),{P_ni},Centros,Tipo,var_c,var_muu);
