...
function FBRSYMFILESV2(SaveDire,sym_vars,fbr,OperadoresY,OperadoresX,varargin)
...
%%%%%%%%%%%%%%%%%%Calculos symbolicos
for j= 1:n
    fbrAnzatzaux(j) = {multioperator(Phi,OperadoresY{j},sym_vars,2)};
end


for j= 1:m
    for i= 1:n
        fbraux = multioperator((fbrAnzatzaux{i}),OperadoresX{j},sym_vars,2);
