...
t21 = NY1.*t4.*t19;
t22 = -t20;
fbraux = c.^2.*muu.*mp('1.0')./(c.*(t6+t7)+mp('1.0')).^(mp('7.0')./mp('2.0')).*(-NX2.^2.*(t20-t21)+NY2.^2.*(t20-t21)+NX2.*NY2.*(NY1.*t5.*(c.*(t6.*mp('4.0')-t7)-mp('1.0'))+NX1.*t4.*(c.*(t6-t7.*mp('4.0'))+mp('1.0'))).*mp('4.0')).*-mp('3.0');
