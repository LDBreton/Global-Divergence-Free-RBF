...
Lap1 = @(f) -muu*laplacian(f(1),[x1,y1]);
Lap2 = @(f) -muu*laplacian(f(2),[x1,y1]);
%
...
OperadoresX = {L1,L2,B1,B2,Px,Py,Lap1,Lap2}; %operadores que le vamos aplicar al anzatz
